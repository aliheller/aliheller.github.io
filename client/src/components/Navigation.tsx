  ...
  return (
    ...
    >
      <div className="container flex items-center justify-between h-16 md:h-20">
        ...
        <Link href="/">
          <span
            className={`font-display text-xl md:text-2xl tracking-wide transition-colors duration-300 ${
              scrolled || menuOpen ? "text-[#1A1714]" : "text-white"
            }`}
        ...
        >
          <span
            className={`block w-6 h-px transition-all duration-300 ${
              scrolled || menuOpen ? "bg-[#1A1714]" : "bg-white"
