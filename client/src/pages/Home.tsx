          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                period: "2019 – 2020",
                desc: "Oversaw the scope, rigor, and impact of research across nine teams. Led in-field foundational research in India, Brazil, and Indonesia with 30+ cross-functional partners. Shaped team and org-level product strategy, roadmaps, metrics, and goals.",
              },
            ].map((item, i) => (
